...
function TermOfUse() {
  ...
  return (
    <div>
          <Helmet>
        <title>Terms of Use - Exos</title>
        <meta name="description" content="Review the Terms of Use for Exos. Understand your rights and responsibilities as a user of Exos' website and services." />
        <meta name="keywords" content="Exos terms of use, legal terms, user agreement, service conditions, website usage terms" />
      </Helmet>
      <div>
      <Menu/>
      </div>
      ...
      {/* content Our contact */}
      {/* content Our contact */}
      <div className="imageTermOfUse">
        <h1 className="titleTermOfUse">TERM OF USE</h1>
      </div>
