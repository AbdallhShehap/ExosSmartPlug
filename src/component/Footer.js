...
export default function Footer() {
  return (
    ...
    <div className='container-fluid'>
      <div className='row'>
      {/* footer logo */}
        <div className='col-sm-12 col-md-6 footerlogoContainer' >
          <img src={require("../images/color logo.png")} className='footerlogo' />
        </div>

      {/* social media footer */}
        <div className='col-sm-12 col-md-6 footerSocialContainer'>
